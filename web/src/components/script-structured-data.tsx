...
function buildScriptFaqs(
  ...
  if (script.minRole) {
    faqs.push({
      ...
      answer: `Running the ${title} script requires at least the ${script.minRole} role in Microsoft Entra ID, in addition to the declared Microsoft Graph permissions. Apply least privilege and avoid using Global Administrator unless a script explicitly requires it.`,
    });
  }
