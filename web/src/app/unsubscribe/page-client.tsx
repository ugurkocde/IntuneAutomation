        ...
        <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-md items-center px-4 py-20">
          ...
          >
            ...
            <div className="px-6 py-10 text-center">
              ...
              {status === "success" && (
                <>
                  ...
                  <button
                    ...
                    className="ring-accent bg-foreground text-background focus-visible:ring-offset-background inline-flex h-11 items-center gap-2 rounded-md px-5 text-sm font-medium shadow-[inset_0_1px_0_color-mix(in_oklab,white_18%,transparent)] transition-transform duration-150 hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none active:translate-y-0"
                  >
                    Re-subscribe
                  </button>
                </>
              ...
              {status === "error" && (
                <>
                  <span
                    aria-hidden="true"
                    className="bg-destructive/15 mx-auto mb-5 inline-flex h-12 w-12 items-center justify-center rounded-full"
                  >
                    <XCircle
            ...
            >
              <a
                href="/"
                className="text-muted-foreground hover:text-foreground inline-flex items-center gap-1 font-mono text-[11px] tracking-[0.14em] uppercase transition-colors"
              >
                ← Return to homepage
              </a>
            </div>
