            ...
            <div className="space-y-3 pt-1">
              ...
              {quota && (
                <div className="flex flex-col gap-1">
                  ...
                  {/* Lifetime social-proof counter. "By the community" is
                    explicit so it can't be misread as a personal running
                    total alongside the daily quota above. Hidden until the
                    fetch resolves so the form doesn't flash a "0 generated"
                    momentary state. */}
                  {totalCount != null && totalCount > 0 && (
                    <p className="text-muted-foreground/70 text-[11px] tabular-nums">
                      {totalCount.toLocaleString()}{" "}
                      {totalCount === 1 ? "script" : "scripts"} generated by
